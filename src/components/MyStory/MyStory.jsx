...
import { MDBCol, MDBContainer, MDBRow, MDBTypography, MDBBox} from "mdbreact";
    ...
    <div id="myStory" className="pageHeight">
      <div className="section">
        ...
        <ReactWOW animation="fadeInUp">
          ...
          <img style={imageStyles2} src="rosebefore2.jpeg" alt=""/>
          ...
          <p>I've been a runner since 2002. Running, lifting weights, cycling and running races are my all time passions. I have no plans stopping these activities anytime soon. However, as  time went on, I knew that I couldn't continue to ignore the extra weight.</p>
          <img style={imageStyles} src="roseketoaf.jpg" alt="" />
